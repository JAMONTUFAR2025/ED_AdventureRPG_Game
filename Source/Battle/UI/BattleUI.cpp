...
namespace Battle
{
    ...
    void BattleUI::setup(Character& playerChar, Character& enemyChar)
    {
        ...
        player_nameText->setPosition(sf::Vector2f(50, 140));
        // TEXTO NIVEL JUGADOR
        ...
        player_healthBarFront.setFillColor(sf::Color::White);
        ...
        // BARRA PP TRASERA
        player_ppBarBack.setSize(sf::Vector2f(200, 10));
        ...
        player_ppBarBack.setPosition(sf::Vector2f(50, 205));
        // BARRA PP DELANTERA
        player_ppBarFront.setSize(sf::Vector2f(0, 10));
        ...
        enemy_nameText->setPosition(sf::Vector2f(GlobalSettings::SCREEN_WIDTH - 250, 140));
        // TEXTO NIVEL ENEMIGO
    ...
    /* Getters */
    sf::Text& BattleUI::getPlayerNameText() { return *player_nameText; }
    sf::Text& BattleUI::getEnemyNameText() { return *enemy_nameText; }
} // namespace Battle
