...
/**
 * Constructor
 * Inicializa los atributos del personaje base con valores por defecto
 */
...
/* Getters */
string& BaseCharacter::getName() { return name; }

int BaseCharacter::getMaxHealth() { return maxHealth; }
int BaseCharacter::getAttack() { return attack; }
int BaseCharacter::getDefense() { return defense; }

int BaseCharacter::getExpYield() { return expYield; }
int BaseCharacter::getPointsYield() { return pointsYield; }